...
const MusicPlayer: React.FC = () => {
  ...
  const handleMouseMove = useCallback(
    (e: MouseEvent) => {
      if (isDragging) {
        const newX = Math.min(
          Math.max(0, e.clientX - initialMousePos.x),
          window.innerWidth - playerRef.current!.offsetWidth
        );
        const newY = Math.min(
          Math.max(60, e.clientY - initialMousePos.y),
          window.innerHeight - playerRef.current!.offsetHeight
        );
    ...
    <div
      ...
      style={{
        ...
        transform: isMinimizing
          ? `translate(${minimizedPosition.x - position.x}px, ${
              minimizedPosition.y - position.y
            }px) scale(0)`
          : "none",
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          right: "10px",
          width: "90%",
          padding: "1.15rem 0 3.5rem 0.5rem",
        ...
        <div id="player">
          ...
          <div id="player-content">
            ...
            <div id="player-controls">
              <div className="control" onClick={toggleShuffle}>
                <div
                  className={`button ${isShuffle ? "active" : ""}`}
                  id="play-shuffle"
                >
